...
$all_tours = [];
$query_all = "SELECT * FROM tours ORDER BY price ASC";
...
<head>
    ...
    <title>Все туры - Туристическое агентство</title>
    <meta name="description" content="Все туры из Москвы. Лучшие цены на отдых в Турции, Египте, Таиланде, ОАЭ. Выбирайте тур онлайн.">
    <link rel='stylesheet' href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css">
    <link rel='stylesheet' href="style.css">
</head>
<body class="page-all-tours">
